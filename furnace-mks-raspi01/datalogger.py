...
class NetworkLogger(object):
    def __init__(self):
        ...
        self.codenames = {
            ...
            '23006959': (0.5, 600),
            '23006958': (0.5, 600),
            '23006960_setpoint': (0.05, 3000),
            '23006959_setpoint': (0.05, 3000),
            '23006958_setpoint': (0.05, 3000),
        }
        ...
        self.db_logger = ContinuousDataSaver(
            continuous_data_table='dateplots_furnaceroom',
